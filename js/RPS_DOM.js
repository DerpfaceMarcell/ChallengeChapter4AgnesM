// const batu = document.querySelector("#rock");
// const kertas = document.querySelector("#paper");
// const gunting = document.querySelector("#scissor");
...
//ini kalo mo manual
// p_rock.addEventListener("mouseover", setBackgroundColor);
// p_rock.addEventListener("mouseleave", removeBackgroundColor);
// p_rock.addEventListener("click", startGame);
